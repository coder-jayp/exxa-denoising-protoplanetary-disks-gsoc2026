...
| Resource | General Test | Image-Based Test |
|----------|-------------|-----------------|
| Colab Notebook | [Open in Colab](https://colab.research.google.com/drive/1fIppebJ2obFtbncZxd8J6cDr_O4kDLa8?usp=sharing) | [Open in Colab](https://colab.research.google.com/drive/1IwcIekgtpDyxjjDNQKbS8ecmciD_KIaP?usp=sharing) |
| Google Drive Outputs | [View Outputs](https://drive.google.com/drive/folders/1ck1IyUC4WgEluBtMInOQbNYiq7OI0xFk?usp=sharing) | [View Outputs](https://drive.google.com/drive/folders/13FJm4BekkhtgUcbUh0kejgzCd3XULzLI?usp=sharing) |

## Repository Structure

```
exxa-denoising-protoplanetary-disks-gsoc2026/
...
@misc{prajapati2026exxa,
  ...
  title  = {GSoC 2026 EXXA Test Solutions: Unsupervised Disk Clustering
             and Attention Autoencoder for Protoplanetary Disk Observations},
  year   = {2026},
  url    = {https://github.com/coder-jayp/exxa-denoising-protoplanetary-disks-gsoc2026}
}
```
